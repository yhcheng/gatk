...
public final class SparkUtils {
    ...
    /**
     * Converts a Hadoop bam shard (eg., a part0000, part0001, etc. file produced by
     ...
     *
     * @param bamShard The Hadoop bam shard to convert
     * @param header header for the BAM file to be created
     * @param destination path to which to write the new BAM file
     */
    public static void convertHadoopBamShardToBam( final File bamShard, final SAMFileHeader header, final File destination ) {
    ...
    /**
     * Private helper method for {@link #convertHadoopBamShardToBam} that takes a SAMFileHeader and writes it
