...
public class ActivityProfile {
     ...
     */
    public List<AssemblyRegion> popReadyActiveRegions(final int activeRegionExtension, final int minRegionSize, final int maxRegionSize, final boolean forceConversion) {
        ...
        while ( true ) {
            final AssemblyRegion nextRegion = popNextReadyActiveRegion(activeRegionExtension, minRegionSize, maxRegionSize, forceConversion);
            if ( nextRegion == null )
                return regions;
            else {
     ...
     */
    private AssemblyRegion popNextReadyActiveRegion(final int activeRegionExtension, final int minRegionSize, final int maxRegionSize, final boolean forceConversion) {
        ...
        return new AssemblyRegion(regionLoc, supportingStates, isActiveRegion, activeRegionExtension, samHeader);
    }
